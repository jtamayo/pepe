...
public class JdbcResultSet extends TraceObject implements ResultSet {
    ...
    public int getInt(int columnIndex) throws SQLException {
        try {
            ...
            //##PEPE
            return get(columnIndex).getInt() + TaintCheck.taint(0, taint);
            //##EPEP
//            return get(columnIndex).getInt();
    ...
    public int getInt(String columnLabel) throws SQLException {
        try {
            ...
            //#PEPE
            return get(columnLabel).getInt() + TaintCheck.taint(0, taint);
            //#EPEP
//            return get(columnLabel).getInt();
    ...
    public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
        try {
            ...
            //##PEPE
            return TaintCheck.taint(get(columnIndex).getBigDecimal(), taint);
//            return get(columnIndex).getBigDecimal();
    ...
    public Date getDate(int columnIndex) throws SQLException {
        try {
            ...
            return TaintCheck.taint(get(columnIndex).getDate(), taint);
//            return get(columnIndex).getDate();
    ...
    public BigDecimal getBigDecimal(String columnLabel) throws SQLException {
        try {
            ...
            //##PEPE
            return TaintCheck.taint(get(columnLabel).getBigDecimal(), taint);
//            return get(columnLabel).getBigDecimal();
    ...
    public Date getDate(String columnLabel) throws SQLException {
        try {
            ...
            return TaintCheck.taint(get(columnLabel).getDate(), taint);
